...
if __name__ == "__main__":
    ...
    parser.add_argument("--cond_dim", help="U Net Model Cond Dim config. (default: 3).", default=3, type=int)
    ...
    parser.add_argument('--cond', required=True, help="Conditional information for model.", type=str)
    ...
    try:
        ...
        cond_list = [float(cond_val) for cond_val in args["cond"].split(',')]

        cond_tensor = torch.tensor([cond_list], device=args["device"]).repeat(args["n"], 1)
